         ...
         <div class="col-lg-4">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="white-box">
                     <div class="user-bg">
                        <img width="100%" alt="user" src="https://wrappixel.com/ampleadmin/ampleadmin-html/plugins/images/large/img1.jpg">
                     ...
                     <div class="user-btm-box">
                        <div class="col-md-6 col-sm-6 text-center">
                           <h5> Số bài viết đã tạo:</h5>
                      
                        </div>

                        <div class="col-md-6 col-sm-6 text-center">
                        <h5> {{ $profile->post->count('name')}}</h5>
                  ...
                  <div class="tab-content">
                     ...
                     <div class="tab-pane fade" id="posts">
                        ...
                        <div class="list-group">
                           ...
                           <a href="tin-tuc/{{ $post->slug }}-{{ $post->id}}.html">
                              <p><i class="fa fa-arrow-circle-right"></i> {{$post->title}} </p>
                           </a>
                           @endforeach
                        </div>
                     </div>
