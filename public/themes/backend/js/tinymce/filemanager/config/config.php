...
//var_dump(file_exists('../../../../../../index.php'),dirname(__FILE__));
...
$upload_dir = '/images/'.$_SESSION['currentFolder']; // path from base_url to base of upload folder (with start and final /)
$current_path =     '../../../../../images/'.$_SESSION['currentFolder']; // relative path from filemanager folder to upload folder (with final /)

if(!is_dir($current_path)){
	die('Folder '.$_SESSION['currentFolder'].' does not exist!');	
}
if(!isset($_SESSION['filemanager']) || $_SESSION['filemanager']!=true){
...
//var_dump($_SESSION["RF"]["language"]);
$default_language 	= $_SESSION["RF"]["language"]; //default language file name
...
$ext_video 	= array('mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg','wma',"flv","webm", 'swf', 'wmv'); //Video 
...
*******************/
$aviary_active 	= TRUE;
$aviary_key 	= "dd6637c9754178fe";
$aviary_secret	= "0d3f123fa73d7bb7";
$aviary_version	= 3;
$aviary_language= 'en';
