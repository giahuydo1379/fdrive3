var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var $language = $('#editable-sample').attr('lang');
            var oTable = $('#editable-sample').dataTable({
                ...
                "aaSorting": [[0, 'asc']],
                "language": {
                    "sProcessing": ($language == 'vi') ? "Đang xử lý..." : "Processing...",
                    "sLengthMenu": ($language == 'vi') ? "_MENU_ dòng trên mỗi trang" : "_MENU_ records per page",
                    "sZeroRecords": ($language == 'vi') ? "Không tìm thấy dòng nào phù hợp" : "No matching records found",
